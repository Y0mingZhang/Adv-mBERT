...
--output_dir /scratch/mihalcea_root/mihalcea1/yimingz/data/training_output/adv-mbert/dual \
...
--src en \
--tgt $TGT \
--model_name_or_path /scratch/mihalcea_root/mihalcea1/yimingz/data/training_output/adv-mbert/dual/en-$TGT/ \
--num_train_epochs 10 \
--ner-lr 2e-5 \
--cache_dir /scratch/mihalcea_root/mihalcea1/yimingz/data/cache_dir \
--output_dir - \
