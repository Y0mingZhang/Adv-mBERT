...
cat /scratch/mihalcea_root/mihalcea1/yimingz/WIKI_DATA/en/en.all | head -n7020 \
 > /scratch/mihalcea_root/mihalcea1/yimingz/WIKI_DATA/en/en.7020

cat /scratch/mihalcea_root/mihalcea1/yimingz/WIKI_DATA/$TGT/$TGT.all | head -n7020 \
 > /scratch/mihalcea_root/mihalcea1/yimingz/WIKI_DATA/$TGT/$TGT.7020
...
--output_dir $OUTDIR \
--train_data_file /scratch/mihalcea_root/mihalcea1/yimingz/WIKI_DATA/en/en.7020 /scratch/mihalcea_root/mihalcea1/yimingz/WIKI_DATA/$TGT/$TGT.7020 \
